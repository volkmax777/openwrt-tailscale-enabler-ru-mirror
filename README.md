...
6. To update the version of tailscale, grab the latest version [here](https://repo-tailscale.lognex.ru/stable/#static) of the form `1.2.10_mips` and replace the same in `/usr/bin/tailscale` and `/usr/bin/tailscaled`: `version="1.2.10_mips"`.
